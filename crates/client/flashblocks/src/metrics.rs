...
pub struct Metrics {
    ...
    /// Count of times flashblocks `base_createAccessList` is called.
    #[metric(describe = "Count of times flashblocks base_createAccessList is called")]
    pub rpc_base_create_access_list: Counter,
